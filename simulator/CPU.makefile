CXX = nvcc
CXXFLAGS = -ccbin /usr/bin/gcc-11 -std=c++14 -Wno-deprecated-gpu-targets -Xcompiler -fopenmp -DTHRUST_DEVICE_SYSTEM=THRUST_DEVICE_SYSTEM_OMP -lgomp
LDFLAGS = -dc -I. -c
MAKEFLAGS += -j
...
# clean target
clean:
	find Fontes -name "*.o" -delete
	find Fontes -name "*.hi" -delete
